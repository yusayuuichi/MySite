                    ...
                    <article>
                        ...
                        <Form.Group className="mb-1" controlId="introduction">
                            <Form.Control
                                ...
                                placeholder="簡介"
                                onChange={event =>
                                    handleUserInfo('introduction', event)
                                }
                ...
                <Col sm={4}>
                    <Form.Group className="mb-1" controlId="cakeresume">
                        <Form.Control
                            ...
                            size="sm"
                            onChange={event =>
                                handleUserInfo('cakeresume', event)
                            }
