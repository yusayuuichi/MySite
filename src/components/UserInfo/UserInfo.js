...
import { IoLocationSharp, IoPhonePortraitOutline, IoMail, IoLogoLinkedin } from 'react-icons/io5';
		...
		return (
			<>
				<Row className='mt-3'>
					<Col sm={6} md={4} lg={4}>
						<Figure>
							<Figure.Image width={250} height={250} alt='Head Shot' src={userInfo?.figure} />
