...
const Skill = () => {
	...
	if (isLoaded) {
		const frontEndSkills = skills?.filter((skill) => 'FrontEnd' === skill.skillType);
		const backEndSkills = skills?.filter((skill) => 'BackEnd' === skill.skillType);
		const databaseEndSkills = skills?.filter((skill) => 'Database' === skill.skillType);
		const learningSkills = skills?.filter((skill) => 'Learning' === skill.skillType);
