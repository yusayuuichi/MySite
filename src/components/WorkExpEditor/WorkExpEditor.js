						...
						<Col key={company?.id} sm={4}>
							<Card className='card-height-editor'>
								...
								<Card.Body className='d-flex flex-column'>
									...
									<Card.Title className='d-flex align-items-center'>
										<Form.Group className='mb-1 w-100' controlId='companyName'>
											<Form.Control
												...
												placeholder='公司名'
												size='sm'
												onChange={(event) => handleCompanys(event, company.id, 'companyName')}
										...
										{(() => {
											if ('Present' === company?.endDate) {
												return (
													<Badge bg='primary' className='ms-2 align-self-center'>
														Now
													</Badge>
												);
											}
									...
									<Card.Title>
										<Form.Group className='mb-1 w-100' controlId='companyAbbName'>
											<Form.Control
												type='text'
												placeholder='公司英文名'
												size='sm'
												onChange={(event) => handleCompanys(event, company.id, 'companyAbbName')}
										...
										<section>
											<Form.Group className='mb-1' controlId='deptName'>
												<Form.Control
													...
													placeholder='部門'
													size='sm'
													onChange={(event) => handleCompanys(event, company.id, 'deptName')}
										...
										<section>
											<Form.Group className='mb-1' controlId='position'>
												<Form.Control
													...
													placeholder='職稱'
													size='sm'
													onChange={(event) => handleCompanys(event, company.id, 'position')}
										...
										<section className='d-flex align-items-center'>
											<Form.Group className='mb-1' controlId='beginDate'>
												<Form.Control
													...
													placeholder='起始日'
													size='sm'
													onChange={(event) => handleCompanys(event, company.id, 'beginDate')}
											...
											<Form.Group className='mb-1' controlId='endDate'>
												<Form.Control
													...
													placeholder='結束日'
													size='sm'
													onChange={(event) => handleCompanys(event, company.id, 'endDate')}
									...
									<Card.Text className='flex-grow-1'>
										<Form.Group className='mb-1' controlId='jobSummary'>
											<Form.Control
												...
												rows={7}
												placeholder='工作概要'
												onChange={(event) => handleCompanys(event, company.id, 'jobSummary')}
					...
					{Array(3)
						...
						.map((_, i) => (
							<Col key={`place${i}`} sm={4}>
								<Card>
									<Card.Img variant='top' src='holder.js/100px214?text=Company' />
